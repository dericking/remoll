...
def main():
    ...
    config = "remoll_ferrous_1017_ext_100M_20220117"
...
#    outDir = "/work/halla/moller12gev/palatchi/moller/remoll/rootfiles/"+config
    ...
    activeDetectors = [1017, 28, 29, 30, 35, 1007]#, 70, 71, 72, 73, 74, 75, 76, 5547, 40, 30, 
...
#?    f.write("/remoll/oldras true\n")
    ...
    f.write("/remoll/evgen/external/file /work/halla/moller12gev/palatchi/moller/remoll/rootfiles/o_remollSkimTree1017.root\n")
    f.write("/remoll/evgen/external/detid 1017\n")
