...
CONFIG="remoll-ferrous-2022-08-02-coll1and2-concreteScraping";
NUMSIMS=2000;
DETNUMA=(2002 2008 2011 2012 9141)
RANDOMN=1234567;
SEQNUMB=1;
NEVENTS=100000;
SECSIMN=100000;
...
for THISSIM in $(seq 1 ${NUMSIMS}); do
  ...
  echo "/remoll/kryptonite/add           CW90"                          >> ${FILE};
  echo "/remoll/kryptonite/add           Water_CW"                      >> ${FILE};
