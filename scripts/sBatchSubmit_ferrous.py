...
def main():
    ...
    config = "remoll_ferrous_parallel_100M_20211211"
...
#    outDir = "/work/halla/moller12gev/palatchi/moller/remoll/rootfiles/"+config
    ...
    activeDetectors = [28, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017]#, 70, 71, 72, 73, 74, 75, 76, 5547, 40, 30, 
